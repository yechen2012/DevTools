...
var TlodAutoSelectLayer = cc.Layer.extend({
    ctor:function (gamelayer) {
        ...
        var autoselectlayer = ccs.load(res.TlodSelectAutoLayer_json);
        ...
        var imgClick = findNodeByName(autoselectlayer.node, "imgClick");
        ...
        var btnAuto25 = findNodeByName(autoselectlayer.node, "btnAuto25");
        btnAuto25.addTouchEventListener(this.onTouchAuto25, this);

        var btnAuto50 = findNodeByName(autoselectlayer.node, "btnAuto50");
        btnAuto50.addTouchEventListener(this.onTouchAuto50, this);

        var btnAuto100 = findNodeByName(autoselectlayer.node, "btnAuto100");
        btnAuto100.addTouchEventListener(this.onTouchAuto100, this);

        var btnAuto200 = findNodeByName(autoselectlayer.node, "btnAuto200");
        btnAuto200.addTouchEventListener(this.onTouchAuto200, this);

        var btnAuto500 = findNodeByName(autoselectlayer.node, "btnAuto500");
    ...
    initEx : function () {
        ...
        this.imgClick = findNodeByName(this.AutoSelectLayer.node, "imgClick");
