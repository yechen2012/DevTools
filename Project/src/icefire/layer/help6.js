...
var IceFireHelpLayer6 = cc.Layer.extend({
    ctor:function (gamelayer) {
        ...
        this.bInit = (res.IceFireHelpLayer6_json != undefined);

        if(!this.bInit)
            return ;

        var helplayer = ccs.load(res.IceFireHelpLayer6_json);
