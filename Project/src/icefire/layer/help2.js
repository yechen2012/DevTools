...
var IceFireHelpLayer2 = cc.Layer.extend({
    ctor:function (gamelayer) {
        ...
        this.bInit = (res.IceFireHelpLayer2_json != undefined);

        if(!this.bInit)
            return ;

        var helplayer = ccs.load(res.IceFireHelpLayer2_json);
