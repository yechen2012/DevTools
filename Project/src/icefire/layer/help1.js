...
var IceFireHelpLayer1 = cc.Layer.extend({
    ctor:function (gamelayer) {
        ...
        this.bInit = (res.IceFireHelpLayer1_json != undefined);

        if(!this.bInit)
            return ;

        var helplayer = ccs.load(res.IceFireHelpLayer1_json);
