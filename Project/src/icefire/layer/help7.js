...
var IceFireHelpLayer7 = cc.Layer.extend({
    ctor:function (gamelayer) {
        ...
        this.bInit = (res.IceFireHelpLayer7_json != undefined);

        if(!this.bInit)
            return ;

        var helplayer = ccs.load(res.IceFireHelpLayer7_json);
