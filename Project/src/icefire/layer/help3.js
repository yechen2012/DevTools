...
var IceFireHelpLayer3 = cc.Layer.extend({
    ctor:function (gamelayer) {
        ...
        this.bInit = (res.IceFireHelpLayer3_json != undefined);

        if(!this.bInit)
            return ;

        var helplayer = ccs.load(res.IceFireHelpLayer3_json);
    ...
    onTouchLeft : function (sender, type) {
        ...
        this.gamelayer.playBtnSound();
        //this.gamelayer.showHelp(2);
        this.gamelayer.beforeHelp(3);
    },
    ...
    onTouchRight : function (sender, type) {
        ...
        this.gamelayer.playBtnSound();
        //this.gamelayer.showHelp(4);
        this.gamelayer.nextHelp(3);
    },
});
